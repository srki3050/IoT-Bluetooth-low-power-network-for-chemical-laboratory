...
#ifndef APP_H
#define APP_H
#define LOWEST_ENERGY_MODE 3 //0 for EMO, 1 for EM1, 2 for EM2, 3 for EM3
//should start from 3
...
//#if lowestenergymode is 0, false - add condition

#if LOWEST_ENERGY_MODE == 0
  #define APP_IS_OK_TO_SLEEP      (false) // for Energy level 0
#else
  #define APP_IS_OK_TO_SLEEP      (true)    // for Energy Level 1,2,3
#endif
...
#define APP_SLEEP_ON_ISR_EXIT   (SL_POWER_MANAGER_IGNORE) //macros
 ...
 * Application Init.
 *****************************************************************************/
void app_init(void); //function prototypes
